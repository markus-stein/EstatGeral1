...
\begin{itemize}
\item A covariância amostral entre $X$ e $Y$ é dado por $\displaystyle{cov(X,Y) = \sum_i \frac{(x_i - \overline x) (y_i - \overline y)}{n}}$, em que 
...
$$
\displaystyle{r = \frac{cov(X, Y)}{\sqrt{S_{XX}S_{YY}}}}
$$
\end{itemize}
