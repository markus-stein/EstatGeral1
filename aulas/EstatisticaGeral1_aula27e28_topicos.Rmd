...
ou
$$ E \left( \left. Y \right| X=x \right) = \int_y y \times P \left( \left. Y=y \right| X=x \right), \text{ se } (X,Y) \text{ é um vetor aleatório contínuo}.$$

* Definição análoga para $E \left( \left. X \right| Y=y \right)$.
* *Propriedades*: ver página 127 das "Notas de Aula MAT02214 - Estatística Geral I".
