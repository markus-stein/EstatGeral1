...
- Ensinar que a **Estatística** é um conjunto de técnicas e também uma linguagem
    ...
    + Quando e comotécnicas descritivas podem ser utilizadas
...
* **Aulas**: terças e quintas, das 07hs 30min às 09hs 10min, na Sala 21 do prédio  Salas de Aula Campus Centro - 11209
    + _07hs 25min:_ chegada
    + _07hs 35min:_ início `r emo::ji("clock")`
    + _09hs:_ fim/dúvidas
    + _09hs 10min:_ saída

* Pandemias, eventos climáticos extremos e recomendaçoes.
...
### Atividades Autônomas $(AA)$
- Serão realizadas duas atividades autônomas por área, pelo moodle.
...
$$
MF = 0,8 \times (P1 + P2 + P3) / 3 + 0,2 \times (AA11 + AA12 + AA21 + AA22 + AA31 + AA32)/6
$$
