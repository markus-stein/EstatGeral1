...
**Exemplo 2**: Após a adoção do atuatendimento em uma rede de lanchonetes, os administradores estão interessados em estudar a relação entre a proproção de tempo em que o caixa está ocupado ao longo do dia ($W$) com a proporção de tempo em que o terminal de autoatendimento está em uso ($Z$).  
* A proporção de tempo em que o terminal de autoatendimento está em uso ($W$) pode estar relacionada com a proporção de tempo que o caixa está atendendo ($Z$)?  
